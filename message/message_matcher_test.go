...
func MatcherSpecificationSpec(c gospec.Context) {
	...
	c.Specify("A MatcherSpecification", func() {
		...
		negative := []string{
			...
			"Timestamp == '2006-01-05T'",
			"Timestamp == '2006-01-05T15:04:05'",
			"Timestamp == '2006-01-05T15:04:05Z'",
			"Timestamp > '2006-02-01'",
			"Timestamp > '2006-02-01T'",
			...
			"Timestamp >= '2006-02-01T15:04:05'",
			"Timestamp >= '2006-02-01T15:04:05Z'",
			"Timestamp < '2003-01-04'",
			"Timestamp < '2003-01-04T'",
			"Timestamp < '2003-01-04T15:04:05'",
		...
		positive := []string{
			...
			"Timestamp > '2006-01-01T'",
			"Timestamp > '2006-01-01T15:04:05'",
			...
			"Timestamp < '2006-01-04T'",
			"Timestamp < '2006-01-04T15:04:05'",
			...
			"Timestamp != '2006-03-04T'",
			"Timestamp != '2006-03-04T15:04:05'",

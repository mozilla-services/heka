...
#    [HG_REPOSITORY url]         # URL of hg repo
#    [HG_TAG tag]                # Hg branch name, commit id or tag
...
execute_process(
  COMMAND \"${hg_EXECUTABLE}\" clone -u \"${hg_tag}\" \"${hg_repository}\" \"${src_name}\"
  WORKING_DIRECTORY \"${work_dir}\"
  RESULT_VARIABLE error_code
  )
if(error_code)
...
function(_ep_add_update_command name)
  ...
  elseif(hg_repository)
    ...
    set(work_dir ${source_dir})
    set(comment "Performing update step (hg update) for '${name}'")
    get_property(hg_tag TARGET ${name} PROPERTY _EP_HG_TAG)
    if(NOT hg_tag)
      set(hg_tag "default")
    endif()

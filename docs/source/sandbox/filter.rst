...
======================
 ...
 - filename (string): For a static configuration this is the full path to the sandbox code. For a dynamic configuration the filename is ignored and the the physical location on disk is controlled by the SandboxManagerFilter.

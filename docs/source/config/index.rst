...
.. code-block:: ini
    ...
    # Used by outputs to extract the payload from a message.
    [PayloadEncoder]
    ...
    # Generates an HTTP dashboard that shows the current state of the Heka
    # instance and any output generated by sandbox filters.
    [DashboardOutput]

...
--[[
Graphs CPU Load and process count data. Expects to receive messages containing
fields entitled `1MinAvg`, `5MinAvg`, `15MinAvg`, and `NumProcesses`, such as
those generated by the :ref:`config_linux_cpu_stats_decoder`.
